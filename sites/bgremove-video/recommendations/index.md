...
| [BGV-0002](BGV-0002-cannibalization.md) | P1 | AI | superseded | Validate homepage and tool-page cannibalization |
| [BGV-0003](BGV-0003-product-ecommerce-intent.md) | P2 | AI | superseded | Separate product tool and ecommerce use-case intent |
| [BGV-0004](BGV-0004-tiktok-creators-intent.md) | P2 | AI | superseded | Separate TikTok tool and creators use-case intent |
...
| [BGV-0010](BGV-0010-home-completion-actions.md) | P1 | User + AI | needs_decision | Improve tool navigation, result actions, and mobile layout |
| [BGV-0011](BGV-0011-remove-account-paid-content.md) | P1 | User + AI | needs_decision | Remove paid-plan content from the authenticated account page |
